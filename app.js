...
window.crearCardHTML = (item, tipo, index) => {
    ...
    const SVG_LLAMAR = `<svg class="btn-icon" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
        ...
        <path fill="currentColor" d="M43.2 39.6c-1.5-1.5-3.4-1.5-4.9 0l-2.3 2.3c-.3-.2-.6-.3-.9-.5-1-.6-2.4-1.4-3.9-2.9-1.5-1.5-2.3-2.9-2.9-3.9-.2-.3-.3-.6-.5-.9l1.6-1.6.7-.7c1.5-1.5 1.5-3.4 0-4.9l-2.3-2.3c-.3-.3-.6-.6-.9-.9-.6-.6-1.3-1.3-2-1.9-1.5-1.4-3.4-1.4-4.9.1l-2.4 2.4c-.6.6-1 1.4-1.1 2.3-.1 1.6.3 3.1.7 4.1 1 2.7 2.6 5.2 4.9 7.8 2.9 3.3 6.4 5.9 10.2 7.6 1.5.6 3.5 1.4 5.6 1.5h.4c1.3 0 2.4-.5 3.2-1.4l.1-.1c.3-.4.6-.7.9-1 .5-.5.9-1 1.4-1.5 1.5-1.6 1.5-3.5 0-5l-2.7-2.6z"/>
    </svg>`;

    const SVG_WHATSAPP = `<svg class="btn-icon" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    const SVG_MAPA = `<svg class="btn-icon" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path fill="#4285F4" d="M96 16C63.3 16 37 42.3 37 75c0 47.6 59 101 59 101s59-53.4 59-101C155 42.3 128.7 16 96 16z"/>
        <circle cx="96" cy="75" r="22" fill="#fff"/>
        <path fill="#1A73E8" d="M96 53c-12.1 0-22 9.9-22 22s9.9 22 22 22 22-9.9 22-22-9.9-22-22-22zm0 36c-7.7 0-14-6.3-14-14s6.3-14 14-14 14 6.3 14 14-6.3 14-14 14z"/>
    </svg>`;
