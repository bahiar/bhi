...
(function() {
    ...
    // Orden estricto acordado: 10 funcionales (con datos) + 1 en construcción.
    ...
    function buildHeaderHTML(type) {
        ...
        if (type === 'full') {
            ...
            html += '<button id="btn-instalar-app" aria-label="Instalar la app BAHI.ar" class="header-btn header-btn--instalar" type="button" hidden>Instalar</button>' +
                '<label class="theme-switch" for="btn-theme-toggle">' +
                '<input type="checkbox" id="btn-theme-toggle" aria-label="Cambiar a modo oscuro">' +
                ...
                '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>' +
                'Ayuda' +
                '</a>';
        } else if (type === 'legal') {
